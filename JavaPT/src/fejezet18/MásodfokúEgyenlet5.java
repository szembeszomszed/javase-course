...
public class MásodfokúEgyenlet5 extends JFrame implements ActionListener, KeyListener {
  ...
  public MásodfokúEgyenlet5() {
    ...
    lbÜzenet.setForeground(Color.RED);
    add(lbÜzenet);
    setVisible(true);
  }
