package fejezet19SzemélyekFájlban3;
...
class Személy implements Comparable, Serializable {
  ...
  public int compareTo(Object o) {
    String névIq1=this.név+Integer.toString(iq);
    String névIq2=((Személy)o).név+Integer.toString(((Személy)o).iq);
    return névIq1.compareTo(névIq2);
  }
}

public class SzemélyekFájlban3 {
  public static void main(String[] args) {
    ...
    System.out.println("A személyek adatai név szerint növekvő sorrendben és azon belül növekvő sorrendben:");
