package fejezet19SzemélyekFájlban2;
...
class Személy implements Comparable, Serializable {
  ...
  public int compareTo(Object o) {
    String név1=this.név;
    String név2=((Személy)o).név;
    return név1.compareTo(név2);
  }
}

public class SzemélyekFájlban2 {
  public static void main(String[] args) {
    ...
    System.out.println("A személyek adatai név szerint növekvő sorrendben:");
