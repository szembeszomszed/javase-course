...
public class SokVéletlenszámFájlban11 {
  ...
  static void fájlFeldolgoz() {
    ...
    int leggyakoribbDb=((SzámÉsDb)vektorSzámÉsDb.get(vektorSzámÉsDb.size()-1)).db;
    System.out.println("A leggyakrabban előforduló szám(ok) és darabszáma(i):");
    i=vektorSzámÉsDb.size()-1;
    while(((SzámÉsDb)vektorSzámÉsDb.get(i)).db==leggyakoribbDb)
